...
public class Mfop001Service {
	...
	public List<RegRecordSereachItem> regRecordSereach(int hisOrdNum, String patCardNo, String patCardType)
		...
		JSONObject responeJson = HisHttpJson.executeHisApi("Query_YRegisterRecord", requestJson);
		RegRecordSereachResponse respone = HisHttpJson.convJsonToBean(responeJson, RegRecordSereachResponse.class);
	...
	public List<PayRecordSereachItem> payRecordSereach(String patCardNo, String patCardType)
		...
		requestJson.put("patCardNo", patCardNo);
		requestJson.put("patCardType", patCardType);
		JSONObject responeJson = HisHttpJson.executeHisApi("MZDJFJLCX", requestJson);
		PayRecordSereachResponse respone = HisHttpJson.convJsonToBean(responeJson, PayRecordSereachResponse.class);
		logger.debug(respone.getResultCode());
		logger.debug(respone.getResultMessage());
