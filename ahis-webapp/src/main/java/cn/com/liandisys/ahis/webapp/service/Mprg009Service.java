...
import cn.com.liandisys.ahis.webapp.his.entity.response.AppointmentCancelResponse;
...
public class Mprg009Service extends AbstractAhisService<Mprg009Form> {
	...
	public String cancelAppointment(String hisOrdNum, String psOrdNum, String cancelReason) {
		...
		json.put("hisOrdNum", hisOrdNum);
		json.put("psOrdNum", psOrdNum);
		json.put("cancelReason", cancelReason);
		JSONObject responeJson;

			responeJson = HisHttpJson.executeHisApi("UnLock_YYRegeister", json);
			AppointmentCancelResponse respone = HisHttpJson.convJsonToBean(responeJson,
					AppointmentCancelResponse.class);
