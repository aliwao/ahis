...
public class HisHttpJson {
	...
	public static JSONObject executeHisApi(String apiPath, JSONObject requestJson) throws UnsupportedEncodingException, JAXBException {
		...
		HttpPost httpUriRequest = new HttpPost(baseUrl + "ase/" + apiPath);
	...
	private static JSONObject convertResponse(HttpEntity entity) throws ParseException, IOException {
		...
		JSONObject resJson = JSONObject.fromObject(aseStr);
		return resJson;
	}
