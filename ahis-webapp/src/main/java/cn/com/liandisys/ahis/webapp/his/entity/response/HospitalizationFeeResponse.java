 ...
 *
 */
public class HospitalizationFeeResponse extends BaseResponse {

	@JSONField(name="item")
	private List<HospitalizationFeeItem> itemList;
	/** 清单开始日期 */
	...
	public List<HospitalizationFeeItem> getItemList() {
		return itemList;
	}

	public void setItemList(List<HospitalizationFeeItem> itemList) {
