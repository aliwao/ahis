...
@Service
@Transactional
public class Mfih003Service {

	@Autowired
	private Mfih001Mapper mfih001Mapper;

	private static final Logger logger = LoggerFactory.getLogger(Mfih003Service.class);
	 ...
	 * @return 住院信息
	 */
	public PatientsHospitalizedInfo getInfoByStayNo(PatientsHospitalizedEntity param) {
		logger.trace("" + param.getUserId());
		return mfih001Mapper.getInfoByStayNo(param);
	}
