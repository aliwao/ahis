...
public class InspReportDetailEntity implements Serializable {
	...
	// 报告详情list
	private List<InspReportDetailBaseItem> inspReportDetailList;
	...
	public List<InspReportDetailBaseItem> getInspReportDetailList() {
		return inspReportDetailList;
	}

	public void setInspReportDetailList(List<InspReportDetailBaseItem> inspReportDetailList) {
